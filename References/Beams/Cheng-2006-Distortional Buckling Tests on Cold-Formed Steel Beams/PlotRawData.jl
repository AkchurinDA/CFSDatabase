...
# Extract test labels:
Directory = "References/Beams/Cheng-2006-Distortional Buckling Tests on Cold-Formed Steel Beams/"
...
begin
    ...
    Label(F[0, 1][1, 1], L"Distortional Buckling Tests on Cold-Formed Steel Beams$$", fontsize=16, tellwidth=false)
    Label(F[0, 1][2, 1], L"Cheng Yu and Benjamin W. Schafer (2006)$$", fontsize=12, tellwidth=false)
